...
/** Autogenerated return type of AddUserToBoard */
export type AddUserToBoardPayload = {
  __typename?: 'AddUserToBoardPayload';
  success: Scalars['Boolean'];
};
...
/** Autogenerated return type of LeaveIssueBoard */
export type LeaveIssueBoardPayload = {
  __typename?: 'LeaveIssueBoardPayload';
  success: Scalars['Boolean'];
};
...
export type Mutation = {
  ...
  addUserToBoard?: Maybe<AddUserToBoardPayload>;
  ...
  leaveIssueBoard?: Maybe<LeaveIssueBoardPayload>;
...
export type MutationLeaveIssueBoardArgs = {
  issueBoardId: Scalars['ID'];
};
...
export type GroupQuery = (
  ...
  & { group: (
    ...
    & { users: Array<(
      ...
      { __typename?: 'IssueBoard' }
      & Pick<IssueBoard, 'id' | 'name' | 'isOwner'>
    )> }
  ) }
);
...
export type LeaveGroupMutation = (
  ...
  & { leaveGroup?: Maybe<(
    { __typename?: 'LeaveGroupPayload' }
    & Pick<LeaveGroupPayload, 'success'>
  )> }
);
...
export type LeaveIssueBoardMutationVariables = Exact<{
  issueBoardId: Scalars['ID'];
}>;


export type LeaveIssueBoardMutation = (
  { __typename?: 'Mutation' }
  & { leaveIssueBoard?: Maybe<(
    { __typename?: 'LeaveIssueBoardPayload' }
    & Pick<LeaveIssueBoardPayload, 'success'>
  )> }
);
...
export type AddUserToBoardMutationVariables = Exact<{
  issueBoardId: Scalars['ID'];
  email: Scalars['String'];
}>;


export type AddUserToBoardMutation = (
  { __typename?: 'Mutation' }
  & { addUserToBoard?: Maybe<(
    { __typename?: 'AddUserToBoardPayload' }
    & Pick<AddUserToBoardPayload, 'success'>
  )> }
);
...
export const LeaveIssueBoardDocument = gql`
  ...
  leaveIssueBoard(issueBoardId: $issueBoardId) {
    ...
    `;
export type LeaveIssueBoardMutationFn = Apollo.MutationFunction<LeaveIssueBoardMutation, LeaveIssueBoardMutationVariables>;

/**
 * __useLeaveIssueBoardMutation__
 *
 * To run a mutation, you first call `useLeaveIssueBoardMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useLeaveIssueBoardMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [leaveIssueBoardMutation, { data, loading, error }] = useLeaveIssueBoardMutation({
 *   variables: {
 *      issueBoardId: // value for 'issueBoardId'
 *   },
 * });
 */
export function useLeaveIssueBoardMutation(baseOptions?: Apollo.MutationHookOptions<LeaveIssueBoardMutation, LeaveIssueBoardMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<LeaveIssueBoardMutation, LeaveIssueBoardMutationVariables>(LeaveIssueBoardDocument, options);
      }
export type LeaveIssueBoardMutationHookResult = ReturnType<typeof useLeaveIssueBoardMutation>;
export type LeaveIssueBoardMutationResult = Apollo.MutationResult<LeaveIssueBoardMutation>;
export type LeaveIssueBoardMutationOptions = Apollo.BaseMutationOptions<LeaveIssueBoardMutation, LeaveIssueBoardMutationVariables>;
...
export const AddUserToBoardDocument = gql`
  ...
  addUserToBoard(issueBoardId: $issueBoardId, email: $email) {
    ...
    `;
export type AddUserToBoardMutationFn = Apollo.MutationFunction<AddUserToBoardMutation, AddUserToBoardMutationVariables>;

/**
 * __useAddUserToBoardMutation__
 *
 * To run a mutation, you first call `useAddUserToBoardMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddUserToBoardMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [addUserToBoardMutation, { data, loading, error }] = useAddUserToBoardMutation({
 *   variables: {
 *      issueBoardId: // value for 'issueBoardId'
 ...
 * });
 */
export function useAddUserToBoardMutation(baseOptions?: Apollo.MutationHookOptions<AddUserToBoardMutation, AddUserToBoardMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddUserToBoardMutation, AddUserToBoardMutationVariables>(AddUserToBoardDocument, options);
      }
export type AddUserToBoardMutationHookResult = ReturnType<typeof useAddUserToBoardMutation>;
export type AddUserToBoardMutationResult = Apollo.MutationResult<AddUserToBoardMutation>;
export type AddUserToBoardMutationOptions = Apollo.BaseMutationOptions<AddUserToBoardMutation, AddUserToBoardMutationVariables>;
